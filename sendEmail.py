...
def sendEmail(parsersResults):
    ...
    for market in parsersResults.keys():
        ...
        tableValuesContent += "<tr><td>" + market + "</td><td>" + marketValues["productDescriptions"] + "</td><td>" + marketValues["productRatings"] + "</td><td>" + marketValues["vendorProfiles"] + "</td><td>" + marketValues["vendorRatings"] + "</td></tr>"
